...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
              <div class="card-header marker">Informações do estabelecimento</div>
              <hr style="margin-top: -3px;" class="outliner2">
                  <div class="row">
                    ...
                    <div class="col-md-6">
                        <button class="btn spec-bt" id="excluir-bt"><a href="{{route('farmacia.removerFarmacia')}}">Excluir perfil</a></button>
                    </div>
                  </div>
                @if ($errors->any())
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('farmacia.editarFarmacia.salvar') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input disabled="true" id="nome" type="text" class="form-control input-stl @error('nome') is-invalid @enderror" name="nome" value="{{ old('nome', $user->nome) }}" required autocomplete="nome" autofocus>
                                @error('name')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input disabled="true" id="cnpj" type="number" class="form-control input-stl @error('cnpj') is-invalid @enderror" name="cnpj" value="{{ old('cnpj', $user->farmacia->cnpj) }}" required autocomplete="cnpj" autofocus>
                                @error('name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input disabled="true" id="email" type="email" class="form-control input-stl @error('email') is-invalid @enderror" name="email" value="{{ old('email', $user->email) }}" required autocomplete="email">
                                @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
